...
Anna re-adjudicated 20 of Beatrice `verdict-herring`'s flagged findings before Esther flattened the matches into the frontend bundle.
...
- **Full upstream chain:**
  ...
  - `beatrice/verdict-herring` — initial status-annotated matches
